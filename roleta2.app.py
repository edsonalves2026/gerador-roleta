...
# ==========================================
# 2.0 FUNÇÕES AUXILIARES DE CÁLCULO E API
# ==========================================
...
# ==========================================
# 3.0 FUNÇÕES AUXILIARES & TELEGRAM
# ==========================================
def enviar_mensagem_telegram(mensagem):
    if not TELEGRAM_BOT_TOKEN or not TELEGRAM_CHAT_ID:
...
# ==========================================
# 3.1 CÁLCULO DE SCORE PONDERADO 🔥
# ==========================================
...
# ==========================================
# 4.0 DISPARO TELEGRAM (RIGOROSO ≥ 7.5)
# ==========================================
...
# ==========================================
# 4.1 CLASSIFICADOR DE TIERS + CACHE
# ==========================================
...
# ==========================================
# 5.0 EXECUÇÃO DO STREAMLIT & ENGINE
# ==========================================
...
# ==========================================
# 6.2 MOTOR DE SCORAGE (ATUALIZADO COM BRK)
# ==========================================
